...
public class Lab11 {
    public static void main(String[] args) {
        ...
        employees.add(new Employee("Tim", "Johnson", 0, 3));
        employees.add(new Employee("Joe", "Darnelle", 1, 2));
        employees.add(new Employee("John", "Daniels", 2, 5));
        employees.add(new Employee("Roger", "Smith", 3,2));
        employees.add(new Employee("Richard", "Carlson", 4, 3));
        employees.add(new Employee("Corey", "Lambdon", 5,1));
        employees.add(new Employee("Ian", "Bronson", 6, 1));
        employees.add(new Employee("Taylor", "Johnson", 7,2));
        employees.add(new Employee("Stephanie", "Roberts", 8, 4));
        employees.add(new Employee("Helen", "Williams", 9, 4));
